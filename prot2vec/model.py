...
from keras.layers import Input, LSTMCell, RNN, Dense, Masking, TimeDistributed
...
class EncDecModel():
    ...
    def _create_models(self):
        ...
        decoder_dense = TimeDistributed(Dense(self.num_targets, activation='softmax', name='dec_dense'))
